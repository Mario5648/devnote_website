...
function get_notes()
{
  ...
  xhr.open("GET", `http://127.0.0.1:5000/get_notes?uid=${uid}&sid=${sid}`)
...
function add_note()
{
  ...
  xhr.open("POST", `http://127.0.0.1:5000/add_note`, true);
...
function get_note_info(uid,sid,nid)
{
  const xhr = new XMLHttpRequest()
  //open a get request with the remote server URL
  xhr.open("GET", `http://127.0.0.1:5000/get_note_info?uid=${uid}&sid=${sid}&nid=${nid}`)
  //send the Http request
  xhr.send()
  //EVENT HANDLERS
  //triggered when the response is completed
...
function edit_note()
{
  ...
  var xhr = new XMLHttpRequest();
  xhr.open("POST", `http://127.0.0.1:5000/edit_note`, true);
  xhr.setRequestHeader('Content-Type', 'application/json');
  xhr.send(JSON.stringify({
      uid: uid,
      name: name,
...
function view_note()
{
  ...
  const xhr = new XMLHttpRequest()
  //open a get request with the remote server URL
  xhr.open("GET", `http://127.0.0.1:5000/view_note?uid=${uid}&sid=${sid}&nid=${nid}`)
  //send the Http request
  xhr.send()
  //EVENT HANDLERS
  //triggered when the response is completed
...
function delete_note()
{
  ...
  const xhr = new XMLHttpRequest()
  //open a get request with the remote server URL
  xhr.open("GET", `http://127.0.0.1:5000/delete_note?uid=${uid}&sid=${sid}&nid=${nid}`)
  //send the Http request
  xhr.send()
  //EVENT HANDLERS
  //triggered when the response is completed
