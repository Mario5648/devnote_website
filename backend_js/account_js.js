function get_user_info()
{
  ...
  xhr.open("GET", `https://devnoteapiprod.azurewebsites.net:5000/get_user_info?uid=${uid}`)
...
function get_coding_style_info()
{
  ...
  const xhr = new XMLHttpRequest()
  //open a get request with the remote server URL
  xhr.open("GET", `https://devnoteapiprod.azurewebsites.net:5000/get_coding_style?uid=${uid}`)
  //send the Http request
  xhr.send()
  //EVENT HANDLERS
  //triggered when the response is completed
...
function update_coding_style()
{
  ...
  const xhr = new XMLHttpRequest()
  //open a get request with the remote server URL
  xhr.open("GET", `https://devnoteapiprod.azurewebsites.net:5000/update_coding_style?uid=${uid}&codingstyle=${coding_style}`)
  //send the Http request
  xhr.send()
  //EVENT HANDLERS
  //triggered when the response is completed
...
function update_user_password()
{
  ...
  const xhr = new XMLHttpRequest()
  //open a get request with the remote server URL
  xhr.open("POST", `https://devnoteapiprod.azurewebsites.net:5000/update_password`)
  //open a get request with the remote server URL
